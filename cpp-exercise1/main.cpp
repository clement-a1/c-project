...
int main() {
    ...
    if (isupper(static_cast<unsigned char>(ch))) {
        cout << "\nUppercase letter" << endl;
    } else {
        cout << "\nNot an uppercase letter" << endl;
    }
...
int main() {
    ...
    if ((n % 2 != 0) && (n % 3 == 0)) {
        cout << "\nNumber is odd and divisible by 3" << endl;
    } else {
        cout << "\nNumber is NOT both odd and divisible by 3" << endl;
    }
